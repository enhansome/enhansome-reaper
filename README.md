...
* [JoepVanlier/JSFX](https://github.com/JoepVanlier/JSFX) ⭐ 640 | 🐛 12 | 🌐 Lua | 📅 2026-09-14 - A bundle of JSFX and scripts by Joep Vanlier (aka saike).
...
* [Python Documentation](https://docs.python.org/3) - The official Python documentation. See also [awesome-python/Resources](https://github.com/vinta/awesome-python#resources) ⭐ 321,069 | 🐛 19 | 🌐 Python | 📅 2026-09-15.
* [Lua Documentation](https://www.lua.org/docs.html) - The official Lua documentation. See also: [awesome-lua/Resources](https://github.com/LewisJEllis/awesome-lua#resources) ⭐ 4,572 | 🐛 50 | 📅 2024-08-11.
